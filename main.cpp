...
// public: 
//     explicit ClusteringProblem(const std::vector<S>& givenSamples, const std::function<int(UnorderedTriple<S>)> tripleCostCB, const std::function<int(UnorderedPair<S>)> pairCostCB  = [](UnorderedPair<S> p)->int{return 0;})
