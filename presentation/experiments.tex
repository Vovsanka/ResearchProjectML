...
\begin{frame}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addvariableplot{data7_of_noise.csv}{opt}{blue}
        \end{axis}
    \end{tikzpicture}
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addvariableplot{data7_of_noise.csv}{acc}{red}
        \end{axis}
    \end{tikzpicture}
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addvariableplot{data10_of_noise.csv}{opt}{blue}
        \end{axis}
    \end{tikzpicture}
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addvariableplot{data15_of_noise.csv}{acc}{red}
        \end{axis}
    \end{tikzpicture}
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addvariableplot{data15_of_noise.csv}{opt}{blue}
        \end{axis}
    \end{tikzpicture}
    }
\end{frame}
