...
\begin{frame}
    ...
    % the cost values are equally distributed on the y-axis in the interval [0, 1]
    % blue values are sorted differently
    \onslide<1->{
        \hspace{-20px}
        \begin{tikzpicture}
            \begin{axis}[
                only marks,
                xlabel=$\cost$, ylabel=$y$,
                grid=major,
                legend style={
                    at={(0.42,0.2)},
                    anchor=south east
                ...
                \addplot[color=blue, mark=*, mark options={scale=0.4}] table[col sep=comma, x=c, y=y] {same_c.csv};
                \addlegendentry{same plane costs}
                \addplot[color=red, mark=*, mark options={scale=0.4}] table[col sep=comma, x=c, y=y] {diff_c.csv};
                \addlegendentry{different plane costs}
            \end{axis}
        \end{tikzpicture}
    }
    ...
    \onslide<2->{
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=blue, mark=*, mark options={scale=0.8}] table[col sep=comma, x=c, y=y] {same_c.csv};
                \addlegendentry{same plane costs}
                \addplot[color=red, mark=*, mark options={scale=0.8}] table[col sep=comma, x=c, y=y] {diff_c.csv};
                \addlegendentry{different plane costs}
            \end{axis}
        \end{tikzpicture}
    }
...
\begin{frame}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            xlabel=\#points/3, ylabel=Computation Time/s,
            xmin=7, xmax=30,
            xmode=log, ymode=log,
            grid=major,
            legend style={
